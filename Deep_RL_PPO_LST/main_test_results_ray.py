...
import utils
from test_trade_env_ray import TradingEnv
...
from ray.data import from_numpy, from_pandas
...
if __name__ == "__main__":
    ...
    register(
        id="test_trading_env_ray-v0",
        entry_point="test_trade_env_ray:TradingEnv",
    )
    ...
    # train_dataset.write_parquet("train_dataset")  # Save train_X as a Parquet file
    ...
    register_env("test_trading_env_ray-v0", env_creator)
    ...
    test_env = gymnasium.make("test_trading_env_ray-v0", input_length=40)
