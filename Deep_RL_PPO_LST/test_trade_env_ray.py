...
hardcoded_dataset = read_parquet("train_X.parquet")
...
class TradingEnv(gym.Env):
    ...
    def reset(self, seed=None, **kwargs):
        ...
        self.iterator = self.data.iter_batches(
        ...
        print("WINDOWED DATASET : ", self.iterator)

        self.sequence_buffer.clear()
        self.load_initial_sequences()
        print("SEQUENCE BUFFER INSIDE RESET : ", self.sequence_buffer)
    ...
    def load_initial_sequences(self):
        ...
        for _ in range(self.input_length):
            ...
            try:
                ...
                print("SEQUENCE BUFFER LOAD INITIAL SEQUENCES : ", self.sequence_buffer)
    ...
    def update_sequences(self, new_data):
        ...
        try:
            ...
            for i in range(len(self.sequence_buffer)):
                ...
                self.sequence_buffer[i][-i - 1, -18:] = new_data
