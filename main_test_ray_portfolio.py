...
def env_creator(env_config):
    return TradingEnvironment(
        ...
        total_episodes=env_config.get("total_episodes", 11),
...
if __name__ == "__main__":
    ...
    register(
        id="test_trading_env_ray_portfolio-v0",
    ...
    register_env("test_trading_env_ray_portfolio-v0", env_creator)
    ...
    config = PPOConfig()
    config.environment(
        env="test_trading_env_ray_portfolio-v0",
        env_config={
            # "data": train_X_ds,
            "input_length": 40,
            "market_fee": 0.0005,
    ...
    test_env = gymnasium.make("test_trading_env_ray_portfolio-v0", input_length=40)
    observation_space = test_env.observation_space
    action_space = test_env.action_space

    # Define the paths
    base_dir = r"C:\Users\marko\ray_results\PPO_2025-01-02_07-24-50\PPO_trading_env_ray_portfolio-v0_456aa_00000_0_2025-01-02_07-24-50\checkpoint_000130"
